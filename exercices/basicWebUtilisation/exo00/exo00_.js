...
// Link info: (409003 (js ()) "exo00_" (("exo00")) (nargs wrong_nargs pollcount poll ffi r1 r0 string make_interned_symbol peps glo module_register modlinkinfo module_registry_init) (exo00) (exo00# ##vm-main-module-ref main ##program-descr document.write) () #f)
...
g_module_registry_init([new G_ModLinkInfo("exo00",0)]);
