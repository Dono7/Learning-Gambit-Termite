...
// Link info: (409003 (js ()) "exo03_" (("exo03")) (nargs wrong_nargs pollcount poll ffi r1 r0 string stack sp make_interned_symbol peps glo module_register modlinkinfo module_registry_init) (exo03) (body-append-br body-append main btn-color ##vm-main-module-ref button-click-set! colored-div exo03# ##program-descr) () #f)
...
g_module_registry_init([new G_ModLinkInfo("exo03",0)]);
