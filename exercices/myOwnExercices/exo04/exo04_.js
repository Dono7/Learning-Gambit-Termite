...
// Link info: (409003 (js ()) "exo04_" (("exo04")) (nargs wrong_nargs pollcount poll r1 pair r0 string ffi r2 stack sp peps build_rest r3 make_interned_symbol glo module_register modlinkinfo module_registry_init) (exo04) (string-append-2 log main exo04# string-append-list car error string-append-multiarg ##vm-main-module-ref ##program-descr cdr) () #f)
...
function g_build_rest_from_stack(nrp) {
  var rest = null;
  if (g_nargs < nrp) {
    return false;
  }
...
g_module_registry_init([new G_ModLinkInfo("exo04",0)]);
