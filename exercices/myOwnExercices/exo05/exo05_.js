...
// Link info: (409003 (js ()) "exo05_" (("exo05")) (nargs wrong_nargs stack sp r0 r1 string pollcount poll glo peps make_interned_symbol pair ffi cpxnum char module_register modlinkinfo module_registry_init) (body exo05 mysquare) (DOM-log exo05# error rat? log DOM-getById log-comp imag-part body log-real body-prepend-br int? log-str log-int positive? log-rat log-char mysquare body-append-br body-append ##vm-main-module-ref comp? str? DOM-body body-append-text-br log-obj float? ##program-descr) (body mysquare) #f)
