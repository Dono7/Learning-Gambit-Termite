...
// Link info: (409003 (js ()) "exo05_" (("exo05")) (nargs wrong_nargs stack sp r0 r1 string pollcount poll peps make_interned_char flonum cpxnum ratnum make_interned_symbol pair ffi char glo module_register modlinkinfo module_registry_init) (exo05) (log-obj log-rat float? body-append exo05# ##vm-main-module-ref log log-int body-prepend-br int? body-append-text-br rat? log-str log-char positive? log-real num? log-comp log-bool ##program-descr body-append-br comp?) () #f)
